...
export class DashboardComponent implements OnInit, OnDestroy {
    ...
    public selectedDateNameChasier = 'Today';
    ...
    public dateType = [
        ...
        { id: 'threeMonthAgo', name: '3 Months Ago' },
    ...
    ngOnInit(): void {
        ...
        this.getDashboardData(
            this.selectedDateName ? { today: this.today } : undefined
        );
        this.getCashierData(
            this.selectedDateNameChasier ? { today: this.today } : undefined
        );
        this.getProductType(
            this.selectedDateNameProduct ? { today: this.today } : undefined
        );
        this.getProductType(
    ...
    selectDateType(
        ...
        switch (typeNumber) {
            ...
            case 2:
                ...
                this.dateTypeControlChasier.setValue(type.id, {
                    emitEvent: true,
                });
                break;
            case 3:
                this.selectedDateNameProduct = type.name;
                this.dateTypeControlProduct.setValue(type.id, {
                    emitEvent: true,
                });
                break;
            case 4:
    ...
    getDashboardData(params?: {
        ...
        this._service
            .getDashboardData(params) // Pass parameters here
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe({
                next: (response) => {
