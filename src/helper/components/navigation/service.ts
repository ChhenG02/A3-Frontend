...
export class HelperNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, HelperNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: HelperNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): HelperNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: HelperNavigationItem[],
    ...
    getItemParent(
        id: string,
        navigation: HelperNavigationItem[],
        parent: HelperNavigationItem[] | HelperNavigationItem
    ): HelperNavigationItem[] | HelperNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
